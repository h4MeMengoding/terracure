...
export function SplashScreen() {
  return (
    <main className="flex min-h-dvh justify-center bg-[#DFE2DC]">
      <section className="flex min-h-dvh w-full max-w-[460px] flex-col justify-between bg-[#173F36] px-6 pb-[max(32px,env(safe-area-inset-bottom))] pt-8 text-white">
        <div className="flex items-center gap-2 text-xs font-bold text-[#CDE974]">
        ...
        <div>
          ...
          <p className="mt-3 max-w-[260px] text-base font-semibold leading-6 text-[#DCE7E2]">Pemantauan tanah dan rekomendasi agronomi dalam satu tampilan.</p>
        </div>
        <div>
