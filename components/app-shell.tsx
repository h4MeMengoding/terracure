        ...
        <header className="sticky top-0 z-30 flex min-h-[72px] items-center justify-between border-b border-[#DCE2DC] bg-[#EEF1EB] px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-[11px] font-extrabold leading-4 tracking-[0.08em] text-[#637069]">TERRACURE</p>
              <h1 className="truncate text-[24px] font-extrabold leading-[1.12] tracking-[-0.02em]">{title}</h1>
            </div>
          </div>
